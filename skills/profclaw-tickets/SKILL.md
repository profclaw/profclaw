---
name: profclaw-tickets
description: Create, update, and manage tickets in profClaw task manager
version: 1.0.0
metadata: {"profclaw": {"emoji": "🎫", "category": "project-management", "priority": 100, "tools": ["create_ticket", "update_ticket", "list_tickets", "get_ticket", "add_comment", "move_ticket", "assign_ticket"]}}
---

# profClaw Ticket Management

You can create, update, and manage tickets in profClaw. Tickets are like issues/tasks organized into projects.
...
You:
  1. list_projects → returns [{key: "PROFCLAW", ...}]
  2. create_ticket(projectKey="PROFCLAW", title="Login issue", type="bug")
  3. Return: "Created [PROFCLAW-42](/tickets/abc123)"
```
...
1. **Always show clickable links** after creating/updating tickets:
   ```
   "Created ticket [PROFCLAW-42](/tickets/abc123)"
   ```
