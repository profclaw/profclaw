---
name: glinr-projects
description: Create and manage projects in GLINR for organizing tickets
version: 1.0.0
metadata: {"glinr": {"emoji": "📁", "category": "project-management", "priority": 90, "tools": ["create_project", "list_projects"]}}
---

# GLINR Project Management

Projects are containers for organizing tickets. Each project has a unique key prefix (e.g., "GLINR", "MOBILE") used in ticket IDs like GLINR-123.
